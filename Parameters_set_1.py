...
class Parameters:
    ...
    def __init__(self):
        ...
        self.PBW = 1670  # processed Doppler bandwidth [Hz]
        ...
        self.data = 1  # print the data (0 -> no, 1 -> yes)

        # %%%%%%%%%%%%%     SYSTEM PARAMETERS     %%%%%%%%%%%%%

        # Wavelength [m]
        self.wavelength = 0.229#0.03

        # Orbit height [m]
        self.height = 628e3

        # Chirp bandwidth [Hz]
        self.chirp_bandwidth = 38e6
