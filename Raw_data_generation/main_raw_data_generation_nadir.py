import Parameters
from Raw_data_generation import Raw_Data_Generation_nadir
...
if __name__ == '__main__':
    ...
    Raw_Data_Generation_nadir.raw_data_generation_nadir(param, system_flag)

    '%%%%%%%%%% Save parameters in Parameters_nadir.txt %%%%%'

    f = open('Parameters_nadir.txt', "w")
    f.write('# Constants\n'
