...
# DEMOSTRATION OF NADIR ECHO SUPPRESSION WITH A REAL TERRASAR-X SCENE AND A REALISTIC NADIR ECHO USING SHIFTED CHIRPSI)
...
signal_equiv_peak=1.0   # Selection of the averaged maximum backscatter sigma_max_0 of the nadir echo.
                        # This value always references the value of the backscatter that would result if a conventional SAR system were used.22
