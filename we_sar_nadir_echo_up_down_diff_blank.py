...
# The simulation in done for a waveform-encoded SAR using up-and down chirps.
##################################################################
"""
...
i=np.arange(0,200,10)               # Definition how much lines shall be blanked per iteration and how much in total
