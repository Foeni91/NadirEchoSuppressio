...
##################################################################
# Description:
# This code simulates a waveform-encoded SAR system (no range cell migration) using up- and down-chirps.
...
# Code for the simulation of a data set N_rg x N_az = 32768 x 8192 (This is just relevant for the blanking of the nadir echo and imaging reasons.)
##################################################################
"""
...
# DEMOSTRATION OF NADIR ECHO SUPPRESSION WITH A REAL TERRASAR-X SCENE AND A REALISTIC NADIR ECHO USING UP- AND DOWN- CHIRPS
...
folder_name = 'Up_down_Chirp_no_RCM_CR_' + str(CR) + '_n_az_2_' + str(int(np.log2(n_az))) + '_' + dt_string
...
u1=np.load('Raw_data_generation/u1_raw_up_down_chirp_rg_az.npy')            # load raw data of the scene
...
u2=np.load('Raw_data_generation/nadir_echo_raw_up_down_chirp_rg_az.npy')    # load raw data of the nadir echo
...
data_values.write('u[8192+8191+4:8192+8191+4'+str(blanked_lines)+', :] = 0.\n')
data_values.write('u1[8192+8191+4:8192+8191+4'+str(blanked_lines)+', :] = 0.\n')
data_values.write('u2[8192+8191+4:8192+8191+4'+str(blanked_lines)+', :] = 0.\n\n\n')
...
# blanked_parm=nadir_echo_blanking.nadir_echo_blanking_thrashold(u, u1, u2, 250, 6)
#
# data_values.write('Blanked dB Value (amp) ='+str(blanked_parm[1])+"dB \n\n")
# data_values.write('Blanked lines ='+str(blanked_parm[0])+" \n\n")

# plt.plot(blanked_parm[0])
# plt.show()


u[8192+8191+4:8192+8191+4+blanked_lines, :] = 0.
u1[8192+8191+4:8192+8191+4+blanked_lines, :] = 0.
u2[8192+8191+4:8192+8191+4+blanked_lines, :] = 0.
